...
import com.zlobrynya.project.readermang.fragment.fragmentBookmark;
...
public class Bookmark extends BaseActivity {
    ...
    private int getCountSite(){
        ...
        if (classDataBaseViewedHead.whetherThereIsABookmarkInSite("mangachan")) {
            nameSite.add("mangachan");
            count++;
        }
        return count;
    }
