...
/**
 *
 * Create by diegocarloslima (Diego Lima)
 *      https://github.com/diegocarloslima/ByakuGallery/blob/master/ByakuGallery/src/com/diegocarloslima/byakugallery/lib/TouchImageView.java
 *      https://github.com/diegocarloslima
 *
 * Changed by Nikita on 10.03.2016.
 *
 *
 */


public class classTouchImageView extends ImageView {
    ...
    public classTouchImageView(Context context, AttributeSet attrs) {
    ...
    public classTouchImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TouchGestureDetector.OnTouchGestureListener listener = new TouchGestureDetector.OnTouchGestureListener() {
            ...
            public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                ...
                clearAnimation();
                ViewCompat.postInvalidateOnAnimation(classTouchImageView.this);
            ...
            public boolean onScale(ScaleGestureDetector detector) {
                ...
                final float scale = computeScale(getMinScale(), mMaxScale+2, mScale, detector.getScaleFactor());
