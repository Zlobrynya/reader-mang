...
public class MainActivity extends AppCompatActivity {
    ...
    public void Click(View view) {
        ...
        clManga = new classMang("http://readmanga.me","[class=img] img[src]","[class=img] a","[class=tile col-sm-6]");
    ...
    public void AdultManga(View view) {
      //  Intent newInten = new Intent(MainActivity.this,temple_pase.class);
        clManga = new classMang("http://AdultManga.ru","[class=img] img[src]","[class=img] a","[class=tile col-sm-6]");
        clManga.setWhere("/list", "?type=&sortType=rate&offset=", "&max=70", 0);
        startActivity(newInten);
    }

    public void mangafox(View view) {
        clManga = new classMang("http://mangafox.me","[class=manga_img] img[src]","[class=manga_img] ", "[class=list] li");
